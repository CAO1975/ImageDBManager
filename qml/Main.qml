...
ApplicationWindow {
    ...
    property var transitionModel: [
        ...
        "左下向右上", "右上向左下", "左上向右下", "右下向左上", "翻转", "反向翻转", "上下翻转", "上翻转", "弹性缩放", "对角线翻转", "反向对角线翻转", "顶端X轴翻转", "底端X轴翻转", "左侧Y轴翻转", "右侧Y轴翻转", "螺旋飞出飞入", "Y轴翻转2圈", "X轴翻转2圈", "钟摆摆动", "挤压（横向）", "挤压（纵向）", "四分屏随机翻转", "3D百叶窗",
        // 着色器过渡效果（34-85）
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    ThemeColorButton {
                        id: slideshowButton
                        text: window.slideshowActive ? "幻灯片⏹" : "幻灯片▶️"
                        Layout.preferredWidth: 80
                        // 根据幻灯片状态改变背景色
                        background: Rectangle {
